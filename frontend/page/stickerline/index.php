			...
			<div class="row">
				<div class="col-md-12 col-sm-12 animate-box" data-animate-effect="fadeInLeft">
					<div class="text-center blog-select">
						<select class="select-style" onchange="location = this.value;">
							...
							<option class="select-style" value="index.php?page=stickerline" <?php if($_GET['page']=="stickerline"){ echo "selected";}?>> สติ๊กเกอร์ไลน์ หัวใจนาคา</option>
						</select>
					</div>
				</div>
				...
				<div class="col-md-4 col-sm-4 animate-box" data-animate-effect="fadeInLeft">
					<div class="blog-entry">
						<a href="index.php?page=stickerline_detail&id=<?php echo $value['id'];?>" class="blog-img"><img src="./file/stickerline/<?php echo $value['image'];?>" class="img-responsive" alt="วอลเปเปอร์"></a>
						<div class="desc">
							<a href="index.php?page=stickerline_detail&id=<?php echo $value['id'];?>">
								<span>
									<?php if($value['pin']!=0){
									...
									<small> สติ๊กเกอร์ไลน์ หัวใจนาคา</small> 
								</span>
