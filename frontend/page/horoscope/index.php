			...
			<div class="row">
				...
				<div class="col-md-4 col-sm-6 animate-box" data-animate-effect="fadeInLeft">
					<div class="blog-entry">
						<a href="index.php?page=horoscope_detail&id=<?php echo $value['id'];?>" class="blog-img"><img src="./file/horoscope/<?php echo $value['image'];?>" class="img-responsive" alt="พยากรณ์ดวงชะตา หัวใจนาคา"></a>
						<div class="desc">
