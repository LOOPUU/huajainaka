		...
		<div class="colorlib-narrow-content">
			...
			<div class="row">
				<div class="col-md-12 col-sm-12 animate-box" data-animate-effect="fadeInLeft">
					...
					<?php if($data['video']!=""){?>
						<a href="index.php?page=holy_object" class="blog-img">
							<iframe width="100%"  height="600px;" src="<?php echo $data['video'];?>"></iframe>
						</a> 
					<?php }else{?>
						<a href="index.php?page=holy_object" class="blog-img">
							<img src="./file/holy_object/<?php echo $data['image'];?>" class="img-responsive" alt="หัวใจนาคา">
						</a>
					<?php } ?>
						<div class="desc">
							<b><h3><< <a  style="text-decoration: underline;" href="index.php?page=holy_object">วัตถุมงคลเสริมดวง </a></h3> </b>
						<a>
							<span>
					...
					<div class="tab-content">
						<p class="nav nav-tabs">
							...
							<form action="index.php?page=holy_object_detail&id=<?php echo $_GET['id'];?>&action=save" method="post" enctype="multipart/form-data" target="" id="form2" >
