					...
					<div class="row row-bottom-padded-md">
						...
						<div class="col-md-6 animate-box" data-animate-effect="fadeInLeft">
							<div class="about-desc">
								...
								<p><?php echo @$data_about['description'];?></p>
							</div>
						</div>
					</div>
					<div class="row">
						<div class="col-md-12 animate-box about-desc" data-animate-effect="fadeInLeft">
							<h2 class="colorlib-heading"><?php echo @$data_about['name2'];?></h2>
							<p><?php echo @$data_about['description2'];?></p>
						</div>
					</div>
				</div>
			</div>
