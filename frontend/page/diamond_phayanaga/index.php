			...
			<div class="row">
				...
				<div class="col-md-12 col-sm-12 animate-box" data-animate-effect="fadeInLeft">
					<div class="blog-entry">
						<div class="row">
							<div class="col-md-4">
								<a href="index.php?page=diamond_phayanaga_detail&id=<?php echo $value['id'];?>" class="blog-img"><img src="./file/diamond_phayanaga/<?php echo $value['image'];?>" class="img-responsive" alt="เพชรพญานาค"></a>
							</div>
							<div class="col-md-8 desc">
								<a href="index.php?page=diamond_phayanaga_detail&id=<?php echo $value['id'];?>">
								<span>
									<?php if($value['pin']!=0){
									...
									<small>เพชรพญานาค หัวใจนาคา </small> 
								</span>
								<h3>
									<?php if($value['video']!=""){?>
