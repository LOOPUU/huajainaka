                ...
                <div class="row align-items-center">
                    <div class="col-md-12">
                        ...
                        <ul class="breadcrumb">
                            ...
                            <li class="breadcrumb-item"><a href="backend.php?page=naka_history">ประวัติพญานาค</a></li>
                        </ul>
                    </div>
                </div>
            </div>
                            ...
                            <table class="table table-hover mb-0">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                        <?php if($value['image']!=""){?>
                                            <img src="./file/naka_history/<?php echo $value['image'];?>" style="width:300px;">
                                        <?php }else{?>
                                        ...
                                        <td  class="text-right">
                                            <a href="backend.php?page=naka_history_edit&id=<?php echo $value['id'];?>" type="button" class="btn btn-dark"><i class="fa fa-edit"></i></a>
                                        </td>
                                    </tr>
                                    <?php $i++;} ?>
                                </tbody>
