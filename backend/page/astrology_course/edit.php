<section class="pcoded-main-container">
    <div class="pcoded-content">
        ...
        <!-- [ breadcrumb ] end -->
        <!-- [ Main Content ] start -->
        <form method="post" action="backend.php?page=astrology_course_edit&id=<?php echo $data['id'];?>&action=save" enctype="multipart/form-data" target="" id="form">
        <div class="row">
            <!-- [ form-element ] start -->
            <div class="col-sm-12">
                <div class="card">
                    ...
                    <div class="card-body">
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="form-group" id="refresh_div">
                                        <?php if($data['image']!=""){?>
                                            ...
                                            <p class="box-image">
                                                <a href="./file/astrology_course/<?php echo $data['image'];?>" target="_blank"><img src="./file/astrology_course/<?php echo $data['image'];?>" style="width:300px;"> </a>
                                                <button id="check_del" data-url="backend.php?page=astrology_course_delete_image&id=<?php echo $data['id'];?>&image=<?php echo $data['image'];?>" onclick="delete_confirm()" style="width: 100%;" type="button" class="btn btn-danger"> <i class="fa fa-trash"></i> ลบ</button>
                                            </p>
                                        <?php }else{ ?>
                                ...
                                <div class="col-md-12">
                                    <div class="form-group" id="refresh_div_video">
                                        <?php if($data['video']!=""){?>
                                            <label for="name">วิดีโอ</label><br>
                                            <p class="box-image">
                                                <a href="./file/astrology_course/<?php echo $data['video'];?>" target="_blank"><img src="https://iili.io/HG4uyzB.jpg" style="width:300px;"> </a>
                                                <!-- <video width="100%" height="500" controls autoplay>
                                                  <source src="./file/astrology_course/<?php echo $data['video'];?>" type="video/mp4">
                                                  คอร์สเรียนโหราศาสตร์ออนไลน์ ฉบับที่ 1
                                                </video> -->
                                                ...
                                                <button id="check_del_video" data-url="backend.php?page=astrology_course_delete_video&id=<?php echo $data['id'];?>&video=<?php echo $data['video'];?>" onclick="delete_confirm_video()" style="width: 100%;"  type="button" class="btn btn-danger"> <i class="fa fa-trash"></i> ลบ</button>
                                            </p>
                                        <?php }else{ ?>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="price" class="form-control" id="price"  placeholder="ราคา" value="<?php echo $data['price'];?>" required>
                                    </div>
                                </div>
                                <div class="col-md-12">
                                    <div class="form-group">
