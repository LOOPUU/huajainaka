                            ...
                            <table class="table table-hover mb-0">
                                <thead>
                                    <tr>
                                        ...
                                        <th><center>รูปภาพ/วิดีโอ</center></th>
                                        <th>ชื่อ</th>
                                        <th>ราคา</th>
                                        <th>รายละเอียด</th>
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                        <?php if($value['image']!=""){?>
                                            <img src="./file/astrology_course/<?php echo $value['image'];?>" style="width:300px;">
                                        <?php }?>
                                        <?php if($value['video']!=""){?>
                                        <br>
                                        <center>
                                        <hr>
                                        <b>
                                            <img src="https://iili.io/HG4uyzB.jpg" style="width:50px;">
                                            <a href="./file/astrology_course/<?php echo $value['video'];?>" target="_blank"><?php echo $value['video'];?>
                                            </a>
                                        </b>
                                        </center>
                                        </td>
                                        ...
                                        <td  class="text-right">
                                            <a href="backend.php?page=astrology_course_edit&id=<?php echo $value['id'];?>" type="button" class="btn btn-dark"><i class="fa fa-edit"></i></a>
                                        </td>
                                    </tr>
                                    <?php $i++;} ?>
                                </tbody>
