                        ...
                        <div class="table-responsive">
                            <table class="table table-hover mb-0">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        <td><?php echo $i;?></td>
                                        <td><img src="./file/banner/<?php echo $value['image'];?>" style="width:300px;"></td>
                                        ...
                                        <td  class="text-right">
                                            <a href="backend.php?page=banner_edit&id=<?php echo $value['id'];?>" type="button" class="btn btn-dark"><i class="fa fa-edit"></i></a>
                                        </td>
                                    </tr>
                                    <?php $i++;} ?>
                                </tbody>
