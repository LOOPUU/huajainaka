<section class="pcoded-main-container">
    <div class="pcoded-content">
        ...
        <!-- [ breadcrumb ] end -->
        <!-- [ Main Content ] start -->
        <form method="post" action="backend.php?page=menu_edit&id=<?php echo $data['id'];?>&action=save" enctype="multipart/form-data" target="" id="form">
        <div class="row">
            <!-- [ form-element ] start -->
            <div class="col-sm-12">
                <div class="card">
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" id="url"  placeholder="url"   value="<?php echo $data['url'];?>"  disabled>
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="form-group">
