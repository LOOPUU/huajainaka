                            ...
                            <table class="table table-hover mb-0">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                        <?php if($value['image']!=""){?>
                                            <img src="./file/color_car/<?php echo $value['image'];?>" style="width:300px;">
                                        <?php }else{?>
                                        ...
                                        <td  class="text-right">
                                            <a href="backend.php?page=color_car_edit&id=<?php echo $value['id'];?>" type="button" class="btn btn-dark"><i class="fa fa-edit"></i></a>
                                        </td>
                                    </tr>
                                    <?php $i++;} ?>
                                </tbody>
