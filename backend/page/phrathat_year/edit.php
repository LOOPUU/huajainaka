<section class="pcoded-main-container">
    <div class="pcoded-content">
                ...
                <div class="row align-items-center">
                    <div class="col-md-12">
                        ...
                        <ul class="breadcrumb">
                            ...
                            <li class="breadcrumb-item"><a href="backend.php?page=phrathat_year">พระธาตุประจำปีเกิด</a></li>
                        </ul>
                    </div>
                </div>
            </div>
        ...
        <!-- [ breadcrumb ] end -->
        <!-- [ Main Content ] start -->
        <form method="post" action="backend.php?page=phrathat_year_edit&id=<?php echo $data['id'];?>&action=save" enctype="multipart/form-data" target="" id="form">
        <div class="row">
            <!-- [ form-element ] start -->
            <div class="col-sm-12">
                <div class="card">
                                ...
                                <div class="col-md-12">
                                    <div class="form-group" id="refresh_div">
                                        <?php if($data['image']!=""){?>
                                            ...
                                            <p class="box-image">
                                                <a href="./file/phrathat_year/<?php echo $data['image'];?>" target="_blank"><img src="./file/phrathat_year/<?php echo $data['image'];?>" style="width:300px;"></a>
                                                <button id="check_del" data-url="backend.php?page=phrathat_year_delete_image&id=<?php echo $data['id'];?>&image=<?php echo $data['image'];?>" onclick="delete_confirm()" style="width: 100%;" type="button" class="btn btn-danger"> <i class="fa fa-trash"></i> ลบ</button>
                                            </p>
                                        <?php }else{ ?>
